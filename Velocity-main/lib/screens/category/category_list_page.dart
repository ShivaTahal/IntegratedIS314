...
import 'package:flutter/src/widgets/image.dart' as InternetImage;
                          ...
                          children: <Widget>[
                            ...
                            Expanded(
                              ...
                              children: <Widget>[
                                ...
                                Text(
                                  '${snapshot.data!.dataCategory[index].description.substring(3, snapshot.data!.dataCategory[index].description.length - 4)}',
                                  style: TextStyle(
